...
function mousePressed(){
	...
	if(mouseX> (width/2-200) && mouseX<(width/2+200) && mouseY> (height - 9*(height/11)-30) && mouseY<(height -9*(height/11)+20)){
		window.open('https://www.openprocessing.org/user/129929');
	}
	if(mouseX> (width-300) && mouseX<(width-100) && mouseY> (height - 9*(height/11)-30) && mouseY<(height -9*(height/11)+20) ){
		window.open('https://github.com/rivera-95');
	}
}
